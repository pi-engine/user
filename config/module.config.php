...
return [
    'service_manager' => [
        ...
        'factories' => [
            ...
            Middleware\RoleAddMiddleware::class                      => Factory\Middleware\RoleAddMiddlewareFactory::class,
            Middleware\RoleEditMiddleware::class                     => Factory\Middleware\RoleEditMiddlewareFactory::class,
            ...
            Validator\RoleNameValidator::class                       => Factory\Validator\RoleNameValidatorFactory::class,
                                ...
                                'options' => [
                                    ...
                                    'defaults' => [
                                        ...
                                        'middleware'  => new PipeSpec(
                                            ...
                                            Middleware\AuthenticationMiddleware::class,
                                            Middleware\AuthorizationMiddleware::class,
                                            Middleware\RoleEditMiddleware::class,
                                            LoggerRequestResponseMiddleware::class,
                                            ErrorMiddleware::class,
                                ...
                                'options' => [
                                    ...
                                    'defaults' => [
                                        ...
                                        'middleware'  => new PipeSpec(
                                            ...
                                            LoggerRequestResponseMiddleware::class,
                                            ErrorMiddleware::class,
                                            Handler\Admin\Online\ListHandler::class
                                        ),
                                    ],
                                ],
                            ],
